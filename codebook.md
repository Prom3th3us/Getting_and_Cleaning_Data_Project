---
title: "Human Activity Recognition Using Smartphones Dataset Version 1.0 - Tidy Dataset Code Book"
author: "Tim Collart"
...
Additionally three variables describe the activity (WALKING, WALKING_UPSTAIRS, WALKING_DOWNSTAIRS, SITTING, STANDING, LAYING) and the subject (1 - 30) on which the measurements were obtained and from which set (test or train):
